...
<p align="center"><img src="docs/img/routing-en.png" width="560" alt="Memory routing: user chat is classified into AGENT.md, USER.md, SKILL.md (service -> database.sql, the kit lane, e.g. LifeKit), or memories/ topic files; manual routing is agent-driven, the AUTO lane is engine-driven and expanded in the next diagram"></p>
