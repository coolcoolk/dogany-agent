...
ONBOARDING_CTX = {
    "en": (
        ...
        "-> form of address -> tone -> humor), waiting for each answer before "
        ...
        "would you like me to call you?'. Do NOT ask about answer format (already "
    ...
    "ko": (
        ...
        "'제가 어떻게 부르면 좋을까요?'처럼 자연스럽게 물으세요. 답변 형식(RULES Output)만 이미 정해졌으니 묻지 마세요. "
