...
- Tier 2: option / pros-cons comparison -> blockquote list, NOT image.
  ...
  "rec: reason" footer. Option labels: bridge.md [[OPTIONS]] label discipline applies;
  recommendation marker may also sit in the footer. Label overflow (>31 chars): button
  falls back to number token (ko "N번" / en "No.N"). Stack items vertically per option (never
