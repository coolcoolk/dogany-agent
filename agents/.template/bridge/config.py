...
# only output, closest to a natural conversation). Wiring only -- no dedicated
# notice copy exists; when enabled the bridge reuses the confirmed /stop copy
# (stop_interrupted) until an auto-interrupt-specific text is owner-approved.
