...
STRINGS = {
    ...
    "help_text": (
        ...
        "/authsync - Sync credentials after re-login\n"
        "/btw <question> - Ask a side question (does not affect the main thread)\n"
        "/help - Show this help\n\n"
    ...
    "cmd_desc_authsync": "Sync credentials after re-login (macOS only)",
    "cmd_desc_btw": "Ask a side question without touching the main thread",
    # --- /btw command (DGN-902) ---
