...
STRINGS = {
    ...
    "help_text": (
        ...
        "/skills - 설치된 스킬 목록\n"
        "/usage - Claude 사용량/한도\n"
        "/authsync - 재로그인 후 자격증명 동기화\n"
        "/btw <질문> - 메인 스레드 오염 없이 곁다리 질문\n"
        "/help - 이 도움말 보기\n\n"
    ...
    # DGN-759: spec help copy confirmed by owner (2026-08-06 "설명만 잘 넣어주고").
    # macOS 전용; Linux 에서는 graceful no-op 문구 사용.
    "cmd_desc_authsync": "재로그인 후 자격증명 동기화 (macOS 전용)",
    "cmd_desc_btw": "메인 스레드 건드리지 않고 곁다리 질문",
    # --- /btw command (DGN-902) ---
    ...
    "authsync_sync_ok": (
        "동기화 완료 (MATCH 확인). 새 자격증명을 반영하려면 봇 재기동을 권장합니다."
    ),
