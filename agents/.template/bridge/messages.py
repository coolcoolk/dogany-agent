...
# (auto or /stop) -- unlike STOP_BG_NOTE, which is a standing generic
# warning shown on every soft-stop regardless of whether anything was
# actually running. {names} = comma-joined descriptions. Copy
