...
# character count). Measured on an iPhone 13 mini (owner, 2026-07-24 + 2026-08-07
# recalibration, DGN-779): a label stays on one comfortable line while the
# weighted width stays at or under 31, counting CJK / full-width glyphs as 1.5,
# whitespace as 0.4, and everything else (latin/digit/symbol) as 1.0.
# Whitespace was previously counted as 1.0, overstating its real width by ~2.7x
# (on-device measurement: actual whitespace width ~0.25 units). The 31.0 cap
# reflects a measured 1-line boundary of ~31.5 weighted units with 1.0 reserved
# for the ellipsis glyph. Roughly 18-20 pure-Korean chars or ~28 pure-ASCII
# chars fit comfortably -- matching what Telegram actually renders.
