...
# $HOME/.local/bin included (DGN-674 F9): the Claude CLI native installer
# lands there, and the launchd plist (newbridge) already carries it -- keep
# both PATH declarations symmetric.
