...
# DGN-1016: auto-interrupt background guard cap -- pin the canonical default
# so a shell-exported override cannot flip the guard off under the suite.
os.environ.pop("BRIDGE_INFLIGHT_DEFER_CAP_S", None)
