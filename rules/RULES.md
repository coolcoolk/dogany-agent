...
- Work-items (backlog, parked, tasks, pending decisions) are never memory -- they live on the ticket surface (status/priority/lifecycle); memory holds durable facts only.
