...
## Output
- Decision-bearing reply -> emit as response skeleton (conclusion / grounds+model / decision, top->bottom); simple answer = conclusion only. Skeleton detail: AGENT 응답 골격 workflow.
