...
<p align="center"><img src="docs/img/routing-ko.png" width="560" alt="기억 라우팅: 사용자 대화가 AGENT.md·USER.md·SKILL.md(service→database.sql, 킷 데이터계약 레인, 예: LifeKit)·memories/ 토픽 파일로 분류됩니다. 수동은 에이전트가, AUTO 갈래는 엔진이 처리하며 다음 도식에서 확대됩니다"></p>
